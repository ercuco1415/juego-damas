...
ValangValidator.prototype = {
    ...
    showValidationFeedback: function(failedRules) {
		...
		// AR 08-04-2008: Showing global errors only makes sense if there are global errors...
    ...
    _findForm: function(name) {
		...
		// AR 08-04-2008: It should throw an exception only if no element was found
        if (!element) {
...
ValangValidator.Form.prototype = {
    ...
    getFields: function() {
        ...
        for (var i = 0; i < tagElements.length; i++) {
			// AR 08-04-2008: It crashes when founds a fieldset, probably it will crash if it finds any child that's not a form field.
